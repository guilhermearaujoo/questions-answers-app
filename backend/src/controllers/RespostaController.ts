...
export default class BookController {
  constructor(private respostaService = new RespostaService()) {}
  ...
  public async deleteResposta(req: Request, res: Response): Promise<Response> {
    const id = Number(req.params.id);
    const serviceResponse = await this.respostaService.deleteResposta(id);
